...
public static class GameModes
{
    ...
    [
        ...
        new GameMode(Guid.Parse("237587C5-3223-4B1C-AECC-FADA6FCF10DE"), "Cricket",
            ...
            0, false, true, true),
        new GameMode(Guid.Parse("246ED1BB-D57A-4778-B062-2B7445E356BD"), "Around the Clock",
            "Gracze muszą trafić każdą liczbę od 1 do 20 po kolei. Pierwszy, kto trafi bullseye po 20, wygrywa.", 0,
            false, true, false),
        new GameMode(Guid.Parse("98C579D9-A550-416F-88B1-C896C5ED62FA"), "Shanghai",
            ...
            0, false, true, true),
        new GameMode(Guid.Parse("3D58E5C8-EFE6-4DC4-8BA9-7DBC9E8D718D"), "Killer",
            ...
            0, false, true, false),
        new GameMode(Guid.Parse("66B95992-2771-4BD8-8CB6-EE36FD0507E5"), "High Score (170)",
        ...
        new GameMode(Guid.Parse("97544A51-2217-449A-BA61-D83BA90664CD"), "Bob’s 27",
